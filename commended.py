...
def generate_svg(name, date_str, out_path):
    ...
    subtitle = "Commended Certificate"
...
<rect x="96" y="96" width="{w - 192}" height="{h - 192}"
      rx="22" fill="none" stroke="url(#goldGrad)" stroke-width="6"/>
...
<g>
    ...
    <text x="{w/2}" y="700"
          ...
          text-anchor="middle"
          fill="#4a4337">
        was commended in the ECHCIC Investment Award 2026
    </text>
</g>
...
def main():
    csv_filename = "commended.csv"
    output_dir = "commended"
